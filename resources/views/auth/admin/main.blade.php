...
<html dir="ltr" lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('css/auth_admin.css')}}">
    <link rel="stylesheet" href="{{asset('page/admin/layout/style.min.css')}}">
  ...
  <div id="main-wrapper">
    ...
    <script type="text/javascript" src="{{asset('js/auth_admin.js')}}"></script>
